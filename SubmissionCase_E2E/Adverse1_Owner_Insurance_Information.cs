...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.AO_LI_ClaimNumber' at Center.", repo.ApplicationUnderTest.AO_LI_ClaimNumberInfo, new RecordItemIndex(6));
            repo.ApplicationUnderTest.AO_LI_ClaimNumber.Click();
            Delay.Milliseconds(9700);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'AO_ClaimNumber_2' with focus on 'ApplicationUnderTest.AO_LI_ClaimNumber'.", repo.ApplicationUnderTest.AO_LI_ClaimNumberInfo, new RecordItemIndex(7));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item 'ApplicationUnderTest.AO_LI_ContactName' at Center.", repo.ApplicationUnderTest.AO_LI_ContactNameInfo, new RecordItemIndex(10));
            repo.ApplicationUnderTest.AO_LI_ContactName.Click();
            Delay.Milliseconds(9700);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'AO_ContactName' with focus on 'ApplicationUnderTest.AO_LI_ContactName'.", repo.ApplicationUnderTest.AO_LI_ContactNameInfo, new RecordItemIndex(11));
            repo.ApplicationUnderTest.AO_LI_ContactName.PressKeys("AO_ContactName");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to 'DC' on item 'ApplicationUnderTest.AO_LI_State'.", repo.ApplicationUnderTest.AO_LI_StateInfo, new RecordItemIndex(12));
            repo.ApplicationUnderTest.AO_LI_State.Element.SetAttributeValue("TagValue", "DC");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'AO_LI_Address1' with focus on 'ApplicationUnderTest.AO_LI_Address1'.", repo.ApplicationUnderTest.AO_LI_Address1Info, new RecordItemIndex(13));
            repo.ApplicationUnderTest.AO_LI_Address1.PressKeys("AO_LI_Address1");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'AO_LI_Address2' with focus on 'ApplicationUnderTest.AO_LI_Address2'.", repo.ApplicationUnderTest.AO_LI_Address2Info, new RecordItemIndex(14));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'AO_LI_City' with focus on 'ApplicationUnderTest.AO_LI_City'.", repo.ApplicationUnderTest.AO_LI_CityInfo, new RecordItemIndex(16));
            repo.ApplicationUnderTest.AO_LI_City.PressKeys("AO_LI_City");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '200020001' with focus on 'ApplicationUnderTest.AO_LI_Zip'.", repo.ApplicationUnderTest.AO_LI_ZipInfo, new RecordItemIndex(17));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to 'Personal' on item 'ApplicationUnderTest.AO_LI_PhoneUseType'.", repo.ApplicationUnderTest.AO_LI_PhoneUseTypeInfo, new RecordItemIndex(20));
            repo.ApplicationUnderTest.AO_LI_PhoneUseType.Element.SetAttributeValue("TagValue", "Personal");
            Delay.Milliseconds(1000);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to 'Cell' on item 'ApplicationUnderTest.AO_LI_PhoneType'.", repo.ApplicationUnderTest.AO_LI_PhoneTypeInfo, new RecordItemIndex(21));
            repo.ApplicationUnderTest.AO_LI_PhoneType.Element.SetAttributeValue("TagValue", "Cell");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to 'Caller ID' on item 'ApplicationUnderTest.AO_LI_PhoneSource'.", repo.ApplicationUnderTest.AO_LI_PhoneSourceInfo, new RecordItemIndex(22));
            repo.ApplicationUnderTest.AO_LI_PhoneSource.Element.SetAttributeValue("TagValue", "Caller ID");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '9500095005' with focus on 'ApplicationUnderTest.AO_LI_PhoneNumber'.", repo.ApplicationUnderTest.AO_LI_PhoneNumberInfo, new RecordItemIndex(23));
